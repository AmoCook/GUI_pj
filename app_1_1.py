...
class ButtonFrame(wx.Frame,object):
                ...
                for item in range(int(well_num)):
                    ...
                    for col in range(ncols):
                        ...
                        if(col_v==var):
                            ...
                            # print('var_data', self.var_data)

                print(self.var_data[0])
    ...
    def OnClick_start(self, event):
        ...
        if(choice_str=='DTW'):
            ...
            #         num_w = whichone
            #
            plt.plot(self.var_data[self.reslut[0][0]], color='red', label='e_str', alpha=0.7, linestyle='-.')
            plt.legend('Curve_found')
            plt.plot(self.var_data[self.reslut[0][1]], color='blue', label='input_str', alpha=0.7, linestyle='--')
            ...
            prefile = '\n\n=============================================\n\n'+'    当前时间为'+str(now_time)+'\n\n'+'       本次匹配的属性为'+self.varible.GetValue()+',共有'+str(num_w)+'口井匹配\n\n'+'DTW匹配结果按从优到劣的顺序排序(格式: 井1 井2 相似度)\n\n'
            file.write(prefile)

            for item1 in range(len(self.reslut)):
                file.write('           '+str(self.reslut[item1][0])+'         '+str(self.reslut[item1][1])+'         '+str(self.reslut[item1][2])+'\n')
            file.close()
